...
import 'package:poc_integration_ml/ml_integration_cubit.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: BlocProvider(
        create: (context) => MlIntegrationCubit(),
        child: BlocBuilder<MlIntegrationCubit, MlIntegrationState>(
              ...
              body: Center(
                child: Column(
                  ...
                  children: [
                    ElevatedButton(
                      onPressed: (){
                        BlocProvider.of<MlIntegrationCubit>(context).pickVideo();
                      },
                    ...
                    if (state is MlIntegrationInitial)
                      CircularProgressIndicator()
                    else
                      if (state is MlIntegrationSucessState)
                        Text('Sentence: ${BlocProvider.of<MlIntegrationCubit>(context).responseModel!.sentence!.join(', ')}')
                      else
